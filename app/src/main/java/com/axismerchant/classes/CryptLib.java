...
public static String SHA512 (String text, int length) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    StringBuffer result = new StringBuffer();
    for (byte b : digest) {
        result.append(String.format("%05o", b)); //convert to octal
    }
    //return result.toString();
